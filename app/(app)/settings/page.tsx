										...
										{loading ? (
											...
											users.map((user) => (
												<tr key={user.id} className="hover:bg-slate-50/70 transition-colors">
													...
													<td className="px-4 py-3">
														<span
															className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-semibold ${user.role === "admin"
													...
													<td className="px-4 py-3">
														<span
															className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-semibold ${user.active
									...
									{Array.from({ length: Math.min(3, totalPages) }, (_, idx) => {
										...
										return (
											<button
												...
												className={`size-8 rounded-lg text-xs font-semibold ${page === pageNumber

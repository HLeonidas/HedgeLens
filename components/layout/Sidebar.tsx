  ...
  return (
    <aside className="w-64 border-r border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark hidden lg:flex flex-col sticky top-0 h-screen">
      ...
      <div className="p-4 border-t border-border-light dark:border-border-dark">
        <div className="flex items-center gap-3 p-2 bg-slate-50 dark:bg-slate-800 rounded border border-border-light dark:border-border-dark">
          {user.image ? (
            <img
              src={user.image}
        ...
        <Link
          ...
          onClick={onNavClick}
          className="w-full mt-3 flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors"
        >
